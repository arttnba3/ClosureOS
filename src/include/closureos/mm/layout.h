...
#define KERN_DIRECT_MAP_REGION_BASE     0xFFFF000000000000
#define KERN_DIRECT_MAP_REGION_END      0xFFFF7FFFFFFFFFFF

#define KERN_DYNAMIC_MAP_REGION_BASE    0xFFFF800000000000
#define KERN_DYNAMIC_MAP_REGION_END     0xFFFFBFFFFFFFFFFF
